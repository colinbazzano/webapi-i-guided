// import express from 'express'; // ES Modules - don't want to use this
...
//this must be AFTER the creation of the server
server.use(express.json()); // <<<<<<<<<< this is needed to parse JSON from the body in Express
